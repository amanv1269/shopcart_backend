...
//			+ "AND ((:minPrice IS NULL AND:maxPrice IS NULL) OR(p.discountePrice BETWEEN :minPrice AND:maxPrice))"
...
//			+ "CASE WHEN :sort = 'price_low' THEN p.discountedPrice END ASC, "
//			+ "CASE WHEN :sort = 'price_high' THEN p.discountedPrice END DESC")
//	public List<Product> filterProducts(@Param("category") String category, @Param("sort") String sort,
